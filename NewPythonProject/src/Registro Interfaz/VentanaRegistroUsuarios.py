...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsNombre.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsApellido.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsDocumento.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsFechaNac.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsCorreo.SetBackgroundColour("#696969")
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsOtrau.SetBackgroundColour("#696969")
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsCorreoUni.SetBackgroundColour("#696969")
...
#----Creación de un panel de TxtArea, e inclusión  del objeto TxtArea y su Label
		...
		PanelComponentsUsuario.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
...
#----Creación de un panel de ComboBox, e inclusión  del objeto ComboBox y su Label
		...
		PanelComponentsCbxPais.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
...
#----Creación de un panel de ComboBox, e inclusión  del objeto ComboBox y su Label
		...
		PanelComponentsCbxUniversidad.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
		...
		PanelComponentsRCategoria.SetBackgroundColour("#696969")
...
#----Creación de un panel de Buttons, e inclusión  del objeto Buttons y su Label
		...
		PanelComponentsBConfirmar.SetBackgroundColour("#696969") #Asignación de Color de Fondo 
